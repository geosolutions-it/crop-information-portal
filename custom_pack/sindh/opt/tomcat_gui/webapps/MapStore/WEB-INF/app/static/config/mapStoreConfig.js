{
   "geoStoreBase":"http://168.202.254.217/geostore/rest/",
   ...
   "gsSources":{ 
		"nrl":{
			...
			"url": "http://168.202.254.217/geoserver/ows", 
            "layersCachedExtent": [
	...
	"map": {
		"projection": "EPSG:900913",
		"units": "m",
		"center": [7668765.680792, 3008989.5685276],
		"zoom":6,
		"maxExtent": [
		...
		"layers": [
			{
				...
				"name": "nrl:province_boundary",
                "styles":"Province_Boundary_SINDH_style",
				"group": "Admin",
				"visibility": true
			},{
				"source": "nrl",
	...
	"customTools":[
		{
			...
			"extent": [	7419806.033165606,2705882.3355386057,7917725.328418394,3312096.801516548],
		  ...
		  "printService":"http://168.202.254.217/geoserver/pdf/",
		  ...
		  "actionTarget":{
           ...
           "ptype":"gxp_ndvi",
            "dataUrl":"http://168.202.254.217/geoserver/ows",
            "layer":"ndvi:ndvi",
            "outputConfig":{
                  "title":"NDVI",
                  "id":"ndvi",
	   ...
	   },
	   {
		...
		"layerStyle":{"strokeColor":"red","strokeWidth":1,"fillOpacity":0.2,"cursor":"pointer"}, 
          "dataUrl":"http://168.202.254.217/geoserver/ows",
		  "rangesUrl": "http://168.202.254.217/geoserver/nrl/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=nrl:cropdata_ranges&outputFormat=json",
		  "highChartExportUrl" :"http://168.202.254.217/highcharts-export/",
		  "layers":{
        ...
        "dataUrl":"http://168.202.254.217/geoserver/ows",
		"factorsurl":"http://168.202.254.217/geoserver/nrl/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=nrl:agrometdescriptor&max&outputFormat=json",
		"highChartExportUrl" :"http://168.202.254.217/highcharts-export/",
		...
		"ptype":"nrl_crop_status",
		 ...
		 "highChartExportUrl" :"http://168.202.254.217/highcharts-export/",
		  ...
		  "meteorologicalPagesTitleValueText": "AgroMet Variables"
			...
			"loginService":"http://168.202.254.217/geostore/rest/users/user/details/",     
