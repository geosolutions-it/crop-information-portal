{
   "geoStoreBase":"http://168.202.254.216/geostore/rest/",
   ...
   "gsSources":{ 
		"nrl":{
			...
			"url": "http://168.202.254.216/geoserver/ows", 
            "layersCachedExtent": [
	...
	"customTools":[
		{
		  ...
		  "printService":"http://168.202.254.216/geoserver/pdf/",
		  ...
		  "actionTarget":{
           ...
           "ptype":"gxp_ndvi",
            "dataUrl":"http://168.202.254.216/geoserver/ows",
            "layer":"ndvi:ndvi",
            "outputConfig":{
                  "title":"NDVI",
                  "id":"ndvi",
	   ...
	   },
	   {
		...
		"layerStyle":{"strokeColor":"red","strokeWidth":1,"fillOpacity":0.2,"cursor":"pointer"}, 
          "dataUrl":"http://168.202.254.216/geoserver/ows",
		  "rangesUrl": "http://168.202.254.216/geoserver/nrl/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=nrl:cropdata_ranges&outputFormat=json",
		  "highChartExportUrl" :"http://168.202.254.216/highcharts-export/",
		  "layers":{
        ...
        "dataUrl":"http://168.202.254.216/geoserver/ows",
		"factorsurl":"http://168.202.254.216/geoserver/nrl/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=nrl:agrometdescriptor&max&outputFormat=json",
		"highChartExportUrl" :"http://168.202.254.216/highcharts-export/",
		...
		"ptype":"nrl_crop_status",
		 ...
		 "highChartExportUrl" :"http://168.202.254.216/highcharts-export/",
		  ...
		  "meteorologicalPagesTitleValueText": "AgroMet Variables"
			...
			"loginService":"http://168.202.254.216/geostore/rest/users/user/details/",     
