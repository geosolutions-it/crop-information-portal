 ...
 */
package it.geosolutions.geobatch.nrl.csvingest.utils;
...
public class CSVIngestUtils {
	 ...
	 * The s_dec is 1 -- 36 , 1 is the first decade in November 36 is the 3th
	 * decad in October
	 * 
	 * @param month
	 *            must by a short name of the month in english (@see
	 *            {@link DecMonth})
	 * @param decadInMonth
	 *            must be 1, 2 or 3
	 * 
	 ...
	 *             if <code>month</code> or <code>decadInMonth</code> have
	 *             incorrect values
	 */
	 ...
	 * 
	 * @param month
	 *            short name of the month (like Nov, NOV or nov for November)
	 * 
	 * @return DecMonth
	 * 
	 * @throws CSVProcessException
	 *             if <code>month</code> it's a unrecognized string or null
	 */
	 ...
	 * 
	 * @throws CSVProcessException
	 *             if <code>doubleString</code> it's not a double
	 */
