 ...
 */
@Override
public void process(CSVReader reader,ProgressListenerForwarder progress,long rowEstimation) throws CSVProcessException {
    String nextLine[];
    long ok = 0;
    float TOLERANCE =1;
    try {
        ...
        while ((nextLine = reader.readNext()) != null) {
            ...
            try {
                ...
                if (!rowByRow) {
                    throw new CSVProcessException("Could not persist line #" + line + " Entity.\n" + e.getLocalizedMessage(), e);
                }
            }
        }
